    ...
    return (
        <section id="Contact" className="contact--section">
            <div>
                ...
                <h2>Contact Me</h2>
                <p className="text-lg"> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Id, libero.</p>
            </div>
            <form className="contact--form--container">
                ...
                <label htmlFor="choose-topic" className="contact--label">
                    ...
                    <div><button className="btn btn-primary contact--form--btn">Summit</button></div>
            </form>
        </section>
    )
}